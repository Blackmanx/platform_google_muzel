...
#define MTK_CAM_UAPI_AAO_MAX_BUF_SIZE (MTK_CAM_UAPI_AAO_BLK_SIZE * MTK_CAM_UAPI_AAO_MAX_BLK_X * MTK_CAM_UAPI_AAO_MAX_BLK_Y)
#define MTK_CAM_UAPI_AHO_BLK_SIZE (3)
#define MTK_CAM_UAPI_AAHO_HIST_SIZE (6 * 1024 * MTK_CAM_UAPI_AHO_BLK_SIZE + 14 * 256 * MTK_CAM_UAPI_AHO_BLK_SIZE)
#define MTK_CAM_UAPI_AAHO_MAX_BUF_SIZE (MTK_CAM_UAPI_MAX_CORE_NUM * MTK_CAM_UAPI_AAHO_HIST_SIZE)
...
#define MTK_CAM_UAPI_AFO_MAX_BUF_SIZE (MTK_CAM_UAPI_AFO_BLK_SIZ * MTK_CAM_UAPI_AFO_MAX_BLK_NUM)
/**
...
#define MTK_CAM_UAPI_FLK_MAX_BUF_SIZE (MTK_CAM_UAPI_FLK_BLK_SIZE * MTK_CAM_UAPI_FLK_MAX_STAT_BLK_NUM * MTK_CAM_UAPI_FLK_MAX_FRAME_HEIGHT)
